...
class Config(object):
    ...
    def __init__(self, config_file):
        ...
        env_config = os.getenv('VIETSEARCH_CONFIG')
        if env_config:
            print('VIETSEARCH_CONFIG=', env_config)
            # overwrite config if SMARTEXT_CONFIG is set
...
def main():
    conf = Config()
    print(conf.get('elasticsearch', 'elastic.host=localhost'))
